...
<template>
  <div class="border-solid border-2 border-pink-400 min-h-80  overflow-auto w-3/5 flex-col justify-start mx-auto mb-4 mt-5 rounded-lg" style="max-height: 720px;">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-1 " v-if="!serviceDetail">
      <div class="shadow-lg ml-4 mt-4 h-40 w-52 rounded-lg" v-for="service in services">
