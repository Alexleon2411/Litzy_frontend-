        ...
        <div class="absolute inset-y-0 left-0 flex items-center sm:hidden">
          ...
          <button @click="toggleMenu" type="button" class="relative inline-flex items-center justify-center rounded-md p-2 bg-gray-700 text-white hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" >
            ...
            <div class="relative w-6 h-6">
              <spa :class="['hamburguer-line', {'rotate-45 top-2.5': ShowMobileMenu, 'top-1': !ShowMobileMenu}]"></spa>
              <spa :class="['hamburguer-line', {'opacity-0': ShowMobileMenu, 'opacity-100 top-3': !ShowMobileMenu}]"></spa>
              <spa :class="['hamburguer-line', {'rotate--45 top-2.5': ShowMobileMenu, 'top-5': !ShowMobileMenu}]"></spa>
            </div>
